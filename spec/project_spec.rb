...
describe Project do
  describe '#project_name' do
    it 'returns the project project_name' do
      project = Project.new({:project_name => 'Teaching Kids to Code', :id => nil})
      expect(project.project_name).to eq 'Teaching Kids to Code'
    end
  end
  ...
  #
  # describe '#==' do
  #   it 'is the same project if two projects have the same project_name' do
  #     project1 = Project.new({:project_name => 'Teaching Kids to Code', :id => nil})
  #     project2 = Project.new({:project_name => 'Teaching Kids to Code', :id => nil})
  ...
  #     project1 = Project.new({:project_name => 'Teaching Kids to Code', :id => nil})
  #     project1.save
  #     project2 = Project.new({:project_name => 'Teaching Ruby to Kids', :id => nil})
  #     project2.save
  ...
  #     project = Project.new({:project_name => 'Teaching Kids to Code', :id => nil})
  #     project.save
  #     project.update({:project_name => 'Teaching Ruby to Kids', :id => nil})
  #     expect(project.project_name).to eq 'Teaching Ruby to Kids'
  #   end
  # end
  #
  # context '#delete' do
